# 0 "AnarchyFoxyShell.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "AnarchyFoxyShell.c"
...
void parseCommand(const char* input, char* command, char** arguments)
{
    ...
    while (token != 
# 36 "AnarchyFoxyShell.c" 3 4
                   ((void *)0)
# 36 "AnarchyFoxyShell.c"
                       )
    {
        token = strtok(
# 38 "AnarchyFoxyShell.c" 3 4
                      ((void *)0)
# 38 "AnarchyFoxyShell.c"
                          , " \t\n\r\f\v");
        if (token != 
# 39 "AnarchyFoxyShell.c" 3 4
                    ((void *)0)
# 39 "AnarchyFoxyShell.c"
                        )
            arguments[argIndex++] = strdup(token);
    }
    arguments[argIndex] = 
# 42 "AnarchyFoxyShell.c" 3 4
                         ((void *)0)
# 42 "AnarchyFoxyShell.c"
                             ;
}
...
void executeCommand(const char* command, char* const arguments[])
{
    ...
    else if (pid == 0)
    {
        ...
        exit(
# 65 "AnarchyFoxyShell.c" 3 4
            1
# 65 "AnarchyFoxyShell.c"
                        );
    }
    else
    {
        ...
        waitpid(pid, 
# 70 "AnarchyFoxyShell.c" 3 4
                    ((void *)0)
# 70 "AnarchyFoxyShell.c"
                        , 0);
    }
}
...
# 85 "AnarchyFoxyShell.c" 3 4
                                   stdin
# 85 "AnarchyFoxyShell.c"
                                        );
...
# 94 "AnarchyFoxyShell.c" 3 4
                                       ((void *)0)
# 94 "AnarchyFoxyShell.c"
                                           ; i++)
        {
            free(arguments[i]);
            arguments[i] = 
# 97 "AnarchyFoxyShell.c" 3 4
                          ((void *)0)
# 97 "AnarchyFoxyShell.c"
                              ;
        }
    }
